...
S_ABR_INFO = 8  # bit_rate, buffer_size, rebuffering_time, bandwidth_measurement, chunk_til_video_end, jitter, delay
S_PER_INFO = 7  # user_id, resolution, cotent_type, complexity,device_model, sex , age

S_LEN = 8  # take how many frames in the past


S_BRT_OUT = 2  # next_bit_rate, next_fair_bit_rate

S_INFO = S_ABR_INFO + S_PER_INFO + S_BRT_INFO
...
VIDEO_COMPLEX = [1,2]  # level of complexity
DEVICES = [1,2,3]
